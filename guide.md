...
[2. Setup a validator and sync it to the actual state of the network](https://github.com/hungcc/stakewars-iii/blob/main/guide.md#2-setup-a-validator-and-sync-it-to-the-actual-state-of-the-network-challenge-002)
